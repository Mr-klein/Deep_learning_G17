# -*- coding: utf-8 -*-
"""
Created on Fri Jun  7 17:11:07 2019
...
#  add on option transforms.ToPILImage(mode=None)
...
#data_transforms = transforms.Compose([transforms.Resize(224, interpolation=2), transforms.ToPILImage(mode=None),
#                                                                    transforms.ToTensor(),
