...
lossfile = "loss_filters.txt"
weightsfile = 'weights_filters.pth'
Lr = 0.001
Momentum = 0.9
...
class Net(nn.Module):
    def __init__(self):
        ...
        self.conv3 = nn.Conv2d(60,90, 3, padding=1)
        self.conv4 = nn.Conv2d(90,120, 3, padding=1)
        self.pool = nn.MaxPool2d(2, 2)
        # Linear(in_features, out_features, bias=True)
        self.fc1 = nn.Linear(120 * 7 * 7, 240)
