...
lossfile = "loss_filters2.txt"
weightsfile = 'weights_filters2.pth'
Lr = 0.01
Momentum = 0.9
...
class Net(nn.Module):
    def __init__(self):
        ...
        self.conv3 = nn.Conv2d(30, 30, 3, padding=1)
        # MaxPool2d(kernel_size, stride=None, padding=0, dilation=1, 
        #           return_indices=False, ceil_mode=False)
        self.pool = nn.MaxPool2d(2, 2)
        self.conv4 = nn.Conv2d(30, 60, 3, padding=1)
        self.conv5 = nn.Conv2d(60, 60, 3, padding=1)
        self.conv6 = nn.Conv2d(60, 60, 3, padding=1)
        self.pool = nn.MaxPool2d(2, 2)
